...
echo "$($PSQL "SELECT name FROM games AS g FULL JOIN teams ON g.winner_id = teams.team_id OR g.opponent_id = teams.team_id WHERE round = 'Eighth-Final' AND year = 2014 ORDER BY name")"
